/**
 * Rate-limited HTTP client for Colombian legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Colombian-Law-MCP/1.0 (https://github.com/Ansvar-Systems/colombian-law-mcp; hello@ansvar.ai)';
