...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Colombian Law MCP',
    version: context.version,
    jurisdiction: 'CO',
    description: 'Colombian Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Funcion Publica',
        url: 'https://www.funcionpublica.gov.co',
        authority: 'Departamento Administrativo de la Funcion Publica',
      },
    ],
    freshness: {
